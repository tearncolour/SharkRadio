...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq_width = freq_width = 0.4e6
        self.center_freq = center_freq = 433.2e6
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(8, firdes.root_raised_cosine(1.0, samp_rate, symbol_rate, alpha, 88)
        )
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('usb:3.11.5' if 'usb:3.11.5' else iio.get_pluto_uri(), [True, True], 32768, False)
        self.iio_pluto_sink_0.set_len_tag_key('')
        self.iio_pluto_sink_0.set_bandwidth(int(540000))
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bf([-3, -1, 1, 3], 2)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_char*1, samp_rate,True)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 4, 10000))), True)
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc(0.54)
    ...
    def set_symbol_rate(self, symbol_rate):
        ...
        self.interp_fir_filter_xxx_0.set_taps(firdes.root_raised_cosine(1.0, self.samp_rate, self.symbol_rate, self.alpha, 88)
        )
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(433.2e6, self.samp_rate)
    ...
    def get_freq_width(self):
        return self.freq_width

    def set_freq_width(self, freq_width):
